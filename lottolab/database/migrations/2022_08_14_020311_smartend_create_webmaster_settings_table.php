...
class SmartendCreateWebmasterSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smartend_webmaster_settings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('smartend_webmaster_settings');
    }
}
