...
class SmartendCreateWebmasterSectionFieldsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smartend_webmaster_section_fields', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('smartend_webmaster_section_fields');
    }
}
