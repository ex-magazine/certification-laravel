...
class SmartendCreateWebmasterSectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smartend_webmaster_sections', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('smartend_webmaster_sections');
    }
}
