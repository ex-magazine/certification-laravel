...
class SmartendCreatePermissionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('smartend_permissions', function (Blueprint $table) {
            $table->id();
            $table->string('name');
    ...
    {
        Schema::dropIfExists('smartend_permissions');
    }
}
