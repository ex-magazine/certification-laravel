...
<link href="{{ URL::asset('assets/smartend/frontend/css/bootstrap.min.css') }}" rel="stylesheet"/>
<link href="{{ URL::asset('assets/smartend/frontend/css/fancybox/jquery.fancybox.css') }}" rel="stylesheet">
<link href="{{ URL::asset('assets/smartend/frontend/css/jcarousel.css') }}" rel="stylesheet"/>
<link href="{{ URL::asset('assets/smartend/frontend/css/flexslider.css') }}" rel="stylesheet"/>
<link href="{{ URL::asset('assets/smartend/frontend/css/style.css') }}" rel="stylesheet"/>
<link href="{{ URL::asset('assets/smartend/frontend/css/color.css') }}" rel="stylesheet"/>
<link href="{{ URL::asset('assets/smartend/frontend/css/colors.css') }}" rel="stylesheet"/>
