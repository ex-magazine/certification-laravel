...
<head>
    @include('smartend.frontEnd.includes.head')
    @include('smartend.frontEnd.includes.colors')
</head>
<?php
$bdy_class = "";
$bdy_bg_color = "";
...
<div id="wrapper">
    <!-- start header -->
@include('smartend.frontEnd.includes.header')
<!-- end header -->
    ...
    <!-- start footer -->
@include('smartend.frontEnd.includes.footer')
<!-- end footer -->
</div>
@include('smartend.frontEnd.includes.foot')
@yield('footerInclude')
